...
class StackedAreaHundreadChart extends StatefulWidget {
  late Time time;
  final double width;
  StackedAreaHundreadChart({Key? key, required this.time, required this.width})
      : super(key: key);

  @override
  State<StackedAreaHundreadChart> createState() =>
      _StackedAreaHundreadChartState();
}

class _StackedAreaHundreadChartState extends State<StackedAreaHundreadChart> {
