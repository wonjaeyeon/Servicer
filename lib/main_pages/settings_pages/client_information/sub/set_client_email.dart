...
class SetClientEmail extends StatefulWidget {
  ...
  @override
  SetClientEmailState createState() => SetClientEmailState();
}

class SetClientEmailState extends State<SetClientEmail> {
                  ...
                  child: ElevatedButton(
                    ...
                    onPressed: () async {
                      if (formKey.currentState!.validate()) {
                        SettingsHandlerV3().setPreferences(Client.email, controller.text);
