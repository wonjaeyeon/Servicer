...
class IDCheckPage extends StatefulWidget {
  ...
  @override
  State<IDCheckPage> createState() => _IDCheckPageState();
}

class _IDCheckPageState extends State<IDCheckPage> with IconSwitcher {
        ...
        child: Padding(
          ...
          child: SizedBox(
            child:
              ...
              Text("${widget.mallName}에서 사용하는 아이디를 입력해주세요.",
                  ...
                  child: TextFormField(
                    validator: (value) {
                      if (value == null || value.isEmpty) {
                        return '회원 아이디를 입력해주세요.';
                      }
                      // check if the email is valid
                      if (!RegExp(r"^[a-zA-Z0-9.]+@[a-zA-Z0-9]+\.[a-zA-Z]+")
                          .hasMatch(value)) {
                        return '올바른 아이디가 아닙니다.';
                      }
                      return null;
                    },
                ...
                child: ElevatedButton(
                  ...
                  onPressed: () async {
                    Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => PWCheckPage(
                                  mallName: widget.mallName,
                                  initialValue_: "111111111",
                                )));
                  },
                  child: Text('확인'),
                ),
