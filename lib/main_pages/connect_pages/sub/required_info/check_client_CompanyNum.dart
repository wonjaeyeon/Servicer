...
import 'check_client_complete.dart';

class CNCheckPage extends StatefulWidget {
  ...
  @override
  State<CNCheckPage> createState() => _CNCheckPageState();
}

class _CNCheckPageState extends State<CNCheckPage> with IconSwitcher {
        ...
        child: Padding(
          ...
          child: SizedBox(
            child:
              ...
              Text("${widget.mallName}에서 사용하는 사업자 등록번호를 입력해주세요.",
                ...
                child: ElevatedButton(
                  ...
                  onPressed: () async {
                    Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => CheckCompletePage(
