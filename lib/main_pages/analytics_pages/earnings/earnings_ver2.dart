...
class EarningsV2 extends StatefulWidget {
  const EarningsV2({Key? key}) : super(key: key);

  @override
  EarningsV2State createState() => EarningsV2State();
}

class EarningsV2State extends State<EarningsV2> {
  @override
  void initState() {
    super.initState();
  }
