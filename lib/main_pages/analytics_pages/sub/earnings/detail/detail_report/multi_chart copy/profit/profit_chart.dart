...
class ProfitAnalysisChart extends AbstractAnalysisChart {
  ProfitAnalysisChart({Key? key, required double width})
      : super(key: key, width: width);

  @override
  _EarningsAnalysisChartState createState() => _EarningsAnalysisChartState();
}

class _EarningsAnalysisChartState extends AbstractAnalysisChartState {
