...
class PChartAnalysis extends StatefulWidget {
  final String timeRange;
  final String unit;
  PChartAnalysis({Key? key, required this.timeRange, required this.unit})
      : super(key: key);

  @override
  State<PChartAnalysis> createState() => _PChartAnalysisState();
}

class _PChartAnalysisState extends State<PChartAnalysis> {
