...
class EarningsDetailReport extends StatefulWidget {
  const EarningsDetailReport({Key? key}) : super(key: key);

  @override
  State<EarningsDetailReport> createState() => _EarningsDetailReportState();
}

class _EarningsDetailReportState extends State<EarningsDetailReport>
