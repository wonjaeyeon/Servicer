...
class TotalSummaryChart extends StatefulWidget {
  TotalSummaryChart({Key? key, required double width}) : super(key: key);

  @override
  State<TotalSummaryChart> createState() => _TotalSummaryChartState();
}

class _TotalSummaryChartState extends State<TotalSummaryChart> {
