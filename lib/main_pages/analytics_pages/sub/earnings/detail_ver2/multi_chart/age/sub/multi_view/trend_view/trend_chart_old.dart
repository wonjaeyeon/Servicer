...
class TrendViewChartContainerV1 extends StatefulWidget {
  const TrendViewChartContainerV1({super.key});

  @override
  State<TrendViewChartContainerV1> createState() =>
      _TrendViewChartContainerV1State();
}

class _TrendViewChartContainerV1State extends State<TrendViewChartContainerV1>
