...
class GenderAnalysisChart extends StatefulWidget {
  final double width;
  const GenderAnalysisChart({Key? key, required this.width}) : super(key: key);

  @override
  State<GenderAnalysisChart> createState() => _GenderAnalysisChartState();
}

class _GenderAnalysisChartState extends State<GenderAnalysisChart> {
