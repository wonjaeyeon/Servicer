...
class GenderMultiViewChart extends StatefulWidget {
  const GenderMultiViewChart({super.key});

  @override
  State<GenderMultiViewChart> createState() => _GenderMultiViewChartState();
}

class _GenderMultiViewChartState extends State<GenderMultiViewChart>
