...
class AgeSubChartViewChart extends StatefulWidget {
  final Time time;
  final String subViewType;
  const AgeSubChartViewChart(
      {Key? key, required this.time, required this.subViewType})
      : super(key: key);

  @override
  State<AgeSubChartViewChart> createState() => _AgeSubChartViewChartState();
}

class _AgeSubChartViewChartState extends State<AgeSubChartViewChart>
