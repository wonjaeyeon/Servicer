...
class ProductPriceAnalysisChart extends StatefulWidget {
  late Time time;
  final double width;
  ProductPriceAnalysisChart({Key? key, required this.time, required this.width})
      : super(key: key);

  @override
  State<ProductPriceAnalysisChart> createState() =>
      _ProductPriceAnalysisChartState();
}

class _ProductPriceAnalysisChartState extends State<ProductPriceAnalysisChart> {
