...
class GenderSubChartViewChart extends StatefulWidget {
  final Time time;
  final String subViewType;
  const GenderSubChartViewChart(
      {Key? key, required this.time, required this.subViewType})
      : super(key: key);

  @override
  State<GenderSubChartViewChart> createState() =>
      _GenderSubChartViewChartState();
}

class _GenderSubChartViewChartState extends State<GenderSubChartViewChart>
      ...
      children: [
        ...
        Container(
          ...
          child: showMultiViewChart(widget.subViewType,
              MediaQuery.of(context).size.width, widget.time),
        ),
      ],
    );
  }
