...
class ProductPriceChartAnalysis extends StatefulWidget {
  ...
  @override
  State<ProductPriceChartAnalysis> createState() =>
      _ProductPriceChartAnalysisState();
}

class _ProductPriceChartAnalysisState extends State<ProductPriceChartAnalysis> {
  ...
  List<Employee> getEmployeeData() {
    return [
      ...
      Employee("기간 내 총매출 중 비중", "45.3%"),
      Employee("상품 가격 범위", '1.3~5.3만원'),
