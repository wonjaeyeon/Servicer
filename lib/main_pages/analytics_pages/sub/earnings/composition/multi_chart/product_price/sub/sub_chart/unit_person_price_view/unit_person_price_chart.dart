...
class UnitPersonPriceSubChartContainer extends StatefulWidget {
  final double width;
  final Time time;
  const UnitPersonPriceSubChartContainer(
      {Key? key, required this.time, required this.width})
      : super(key: key);

  @override
  State<UnitPersonPriceSubChartContainer> createState() =>
      UnitPersonPriceSubChartContainerState();
}

class UnitPersonPriceSubChartContainerState
    extends State<UnitPersonPriceSubChartContainer> with PChartYAxisUnit {
  ...
  List<_ChartData> getChartData(Time time) {
    ...
    if (time == Time.day) {
      chartData = <_ChartData>[
        _ChartData(5, 40000, Colors.orange[100]),
        _ChartData(10, 60000, Colors.orange[200]),
        _ChartData(15, 80000, Colors.orange[200]),
        _ChartData(20, 10000, Colors.orange[300]),
        _ChartData(25, 80000, Colors.orange[300]),
        _ChartData(30, 60000, Colors.orange[400]),
        _ChartData(35, 45000, Colors.orange[400]),
        _ChartData(40, 20000, Colors.orange[500]),
        _ChartData(45, 40000, Colors.orange[500]),
        _ChartData(50, 60000, Colors.orange[600]),
        _ChartData(55, 800000, Colors.orange[600]),
        _ChartData(60, 100000, Colors.orange[700]),
        _ChartData(65, 800000, Colors.orange[700]),
        _ChartData(70, 600000, Colors.orange[800]),
        _ChartData(75, 40000, Colors.orange[800]),
        _ChartData(80, 20000, Colors.orange[900]),
        _ChartData(85, 40000, Colors.orange[900]),
        _ChartData(90, 60000, Colors.deepOrange[700]),
        _ChartData(95, 80000, Colors.deepOrange[800]),
        _ChartData(100, 100000, Colors.deepOrange[900]),
      ];
