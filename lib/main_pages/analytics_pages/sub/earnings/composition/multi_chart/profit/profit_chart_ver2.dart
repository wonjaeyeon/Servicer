...
import 'sub/analysis/profit_chart_analysis.dart';
import 'sub/multi_view/_multi_view_chart_maker/multi_view_chart.dart';

class ProfitAnalysisChartV2 extends StatefulWidget {
  ProfitAnalysisChartV2({Key? key, required double width}) : super(key: key);

  @override
  State<ProfitAnalysisChartV2> createState() => _ProfitAnalysisChartV2State();
}

class _ProfitAnalysisChartV2State extends State<ProfitAnalysisChartV2> {
        ...
        SfCartesianChart(
          ...
          series: <ChartSeries>[
            AreaSeries<ExpenseData, String>(
              ...
              name: '비용',
              color: Color(0xFFFCC7A91).withOpacity(0.6),
            ),
            AreaSeries<ExpenseData, String>(
                dataSource: getChartData(time),
                xValueMapper: (ExpenseData exp, _) => exp.expenseCategory,
                ...
                name: '수익',
                color: Color(0xff5985B5).withOpacity(0.6)),
          ],
