...
class CashFlowSubChartContainer extends StatefulWidget {
  final double width;
  final Time time;
  const CashFlowSubChartContainer(
      {Key? key, required this.time, required this.width})
      : super(key: key);

  @override
  State<CashFlowSubChartContainer> createState() =>
      CashFlowSubChartContainerState();
}

class CashFlowSubChartContainerState extends State<CashFlowSubChartContainer> {
