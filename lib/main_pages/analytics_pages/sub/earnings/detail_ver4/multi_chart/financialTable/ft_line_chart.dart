...
class FinancialTableChartContainer extends StatefulWidget {
  FinancialTableChartContainer({Key? key, required double width})
      : super(key: key);

  @override
  State<FinancialTableChartContainer> createState() =>
      _FinancialTableChartContainerState();
}

class _FinancialTableChartContainerState
    extends State<FinancialTableChartContainer>
        ...
        child: Container(
            ...
            child: ListView(
                ...
                children: [
                  ...
                  FinancialTableSubChartViewChart(
                    time: time,
