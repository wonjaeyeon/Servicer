...
class AgeAnalysisChartV2 extends StatefulWidget {
  //late Time time;
  final double width;
  AgeAnalysisChartV2({Key? key, required this.width}) : super(key: key);

  @override
  State<AgeAnalysisChartV2> createState() => _AgeAnalysisChartV2State();
}

class _AgeAnalysisChartV2State extends State<AgeAnalysisChartV2>
