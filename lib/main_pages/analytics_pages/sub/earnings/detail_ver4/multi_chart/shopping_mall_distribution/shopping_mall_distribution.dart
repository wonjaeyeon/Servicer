...
import 'package:servicer/data_handler/mapData_handler/get_map_data.dart';
...
import '../../../detail/detail_chart/e_total_chart.dart';
import 'sd_data_handler/y_axis_unit.dart';
import 'sub/chart/treemap_chart.dart';

class ShoppingMallDistributionChart extends StatefulWidget {
  const ShoppingMallDistributionChart({super.key});

  @override
  State<ShoppingMallDistributionChart> createState() =>
      _ShoppingMallDistributionChartState();
}

class _ShoppingMallDistributionChartState
    extends State<ShoppingMallDistributionChart> with TDChartYAxisUnit {
  late Time time;
    ...
    return Padding(
        ...
        child: Column(
          children: [
            ...
            TreemapViewChartContainer(),

            const SizedBox(height: 4),
            Container(
              height: headerHeight,
              color: mallMaster.themeColorOf(Mall.NaverSmartStore),
