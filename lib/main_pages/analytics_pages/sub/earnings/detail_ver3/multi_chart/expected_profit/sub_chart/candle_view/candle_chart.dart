...
class CandleSubChartContainer extends StatefulWidget {
  final double width;
  final Time time;
  const CandleSubChartContainer(
      {Key? key, required this.time, required this.width})
      : super(key: key);

  @override
  State<CandleSubChartContainer> createState() =>
      CandleSubChartContainerState();
}

class CandleSubChartContainerState extends State<CandleSubChartContainer> {
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      child: SfCartesianChart(
        ...
        title: ChartTitle(text: '매출 추이 캔들차트'),
