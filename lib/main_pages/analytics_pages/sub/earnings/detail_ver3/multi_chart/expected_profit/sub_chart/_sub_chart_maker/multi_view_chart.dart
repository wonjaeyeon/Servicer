...
class ExpectedProfitSubChartViewChart extends StatefulWidget {
  final Time time;
  final String subViewType;
  const ExpectedProfitSubChartViewChart(
      {Key? key, required this.time, required this.subViewType})
      : super(key: key);

  @override
  State<ExpectedProfitSubChartViewChart> createState() =>
      _ExpectedProfitSubChartViewChartState();
}

class _ExpectedProfitSubChartViewChartState
    extends State<ExpectedProfitSubChartViewChart>
