...
class DetailMultiChartV3 extends StatefulWidget {
  ...
  @override
  State<StatefulWidget> createState() => DetailMultiChartV3State();
}

class DetailMultiChartV3State extends State<DetailMultiChartV3>
    with MixedChart, FunctionForClass {
  final List<bool> _isSelectedCategory = [true, false, false];
