...
class EarningsLineChartContainer extends StatefulWidget {
  final String title;
  final String unit;
  EarningsLineChartContainer(
      {Key? key, required this.title, required this.unit})
      : super(key: key);

  @override
  State<EarningsLineChartContainer> createState() =>
      _EarningsLineChartContainerState();
}

class _EarningsLineChartContainerState extends State<EarningsLineChartContainer>
    with FunctionForClass, WidgetForClass {
  final items = ['선', '캔들', '증감', '표'];
  String selectedValue = '선';
        ...
        child: Container(
            ...
            child: ListView(
                ...
                children: [
                  ...
                  TrendChartAnalysis(timeRange: getTimeRange(time), unit: "원"),
                ])));
  }
