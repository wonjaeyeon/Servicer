...
class ScatterChartPainter extends AxisChartPainter<ScatterChartData> {
  ...
  @override
  void paint(BuildContext context, CanvasWrapper canvasWrapper, PaintHolder<ScatterChartData> holder) {
  ...
  void drawSpots(
    ...
    if (data.scatterLabelSettings.showLabel) {
      for (int i = 0; i < data.scatterSpots.length; i++) {
        ...
        String label = data.scatterLabelSettings.getLabelFunction(spotIndex, scatterSpot);
        ...
        if (pixelY > centerChartY) {
          ...
          var off = (scatterSpot.radius * 1.5 < tp.height || scatterSpot.radius * 1.5 < tp.width)
  ...
  @visibleForTesting
  void drawTouchTooltips(BuildContext context, CanvasWrapper canvasWrapper, PaintHolder<ScatterChartData> holder) {
  ...
  @visibleForTesting
  void drawTouchTooltip(BuildContext context, CanvasWrapper canvasWrapper, ScatterTouchTooltipData tooltipData,
