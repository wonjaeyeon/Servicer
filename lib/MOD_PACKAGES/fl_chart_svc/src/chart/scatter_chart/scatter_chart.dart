...
import '../../../src/chart/base/axis_chart/axis_chart_scaffold_widget.dart';
import '../../../src/chart/scatter_chart/scatter_chart_renderer.dart';
...
class _ScatterChartState extends AnimatedWidgetBaseState<ScatterChart> {
  ...
  void _handleBuiltInTouch(FlTouchEvent event, ScatterTouchResponse? touchResponse) {
    ...
    final desiredTouch = event is FlPanDownEvent || event is FlPanUpdateEvent || event is FlPointerHoverEvent;
