...
import '../../../src/extensions/rrect_extension.dart';
import '../../../src/extensions/bar_chart_data_extension.dart';
...
class BarChartPainter extends AxisChartPainter<BarChartData> {
  ...
  void paint(BuildContext context, CanvasWrapper canvasWrapper, PaintHolder<BarChartData> holder) {
    ...
    for (var i = 0; i < targetData.barGroups.length; i++) {
      ...
      for (var j = 0; j < barGroup.barRods.length; j++) {
        ...
        drawTouchTooltip(context, canvasWrapper, _groupBarsPosition!, targetData.barTouchData.touchTooltipData, barGroup, i,
            barRod, j, holder);
      }
    }
  }
  ...
  @visibleForTesting
  void drawStackItemBorderStroke(CanvasWrapper canvasWrapper, BarChartRodStackItem stackItem, int index, int rodStacksSize,
      double barThickSize, RRect barRRect, Size drawSize, PaintHolder<BarChartData> holder) {
    ...
    for (var i = 0; i < _groupBarsPosition!.length; i++) {
      ...
      for (var j = 0; j < groupBarPos.barsX.length; j++) {
        ...
        final isYInBarBounds =
            (touchedPoint.dy <= barBotY + touchExtraThreshold.bottom) && (touchedPoint.dy >= barTopY - touchExtraThreshold.top);
