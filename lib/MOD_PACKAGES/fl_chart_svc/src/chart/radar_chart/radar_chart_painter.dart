...
class RadarChartPainter extends BaseChartPainter<RadarChartData> {
  ...
  @override
  void paint(BuildContext context, CanvasWrapper canvasWrapper, PaintHolder<RadarChartData> holder) {
  ...
  @visibleForTesting
  void drawTicks(BuildContext context, CanvasWrapper canvasWrapper, PaintHolder<RadarChartData> holder) {
    final data = holder.data;
  ...
  void drawGrids(CanvasWrapper canvasWrapper, PaintHolder<RadarChartData> holder) {
    final data = holder.data;
    final size = canvasWrapper.size;
  ...
  @visibleForTesting
  void drawTitles(BuildContext context, CanvasWrapper canvasWrapper, PaintHolder<RadarChartData> holder) {
    final data = holder.data;
  ...
  @visibleForTesting
  void drawDataSets(CanvasWrapper canvasWrapper, PaintHolder<RadarChartData> holder) {
    final data = holder.data;
  ...
  RadarTouchedSpot? handleTouch(Offset touchedPoint, Size viewSize, PaintHolder<RadarChartData> holder) {
