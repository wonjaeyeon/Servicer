...
import '../../../src/chart/base/base_chart/render_base_chart.dart';
import '../../../src/chart/line_chart/line_chart_painter.dart';
...
class RenderLineChart extends RenderBaseChart<LineTouchResponse> {
  RenderLineChart(BuildContext context, LineChartData data, LineChartData targetData, double textScale)
      : _data = data,
